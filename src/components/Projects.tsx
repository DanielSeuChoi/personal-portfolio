        ...
        <div className='relative justify-center flex flex-col p-10'>
            <div className='mt-5'>
                ...
                <div className="hover:bg-white" >
                    <Image
                        className='relative h-[10.25rem] w-[20.25rem] rounded-t-lg shadow-2xl transition hover:bg-white'
                        src={imageUrl}
                        alt={'Photo'}
                    />
                </div>
            </div>
            <div className='flex hover:opacity-70 flex-row justify-start mt-5'>
